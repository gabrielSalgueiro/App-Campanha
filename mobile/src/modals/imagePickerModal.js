...
export default function ImagePickerModal({visible, openCamera, openGallery, deleteImage,cancel}){
            ...
            <TouchableWithoutFeedback>
              <View style={styles.modalView}>
                ...
                <FontAwesome name='trash' size={36} color='red'/>
                    <Text style={{...styles.labelText, color: 'red'}}>Remover Foto</Text>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity ={0.4} style={styles.button} onPress={openCamera}>
